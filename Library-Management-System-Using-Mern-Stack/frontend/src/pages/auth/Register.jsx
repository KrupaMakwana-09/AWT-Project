                ...
                <Col md={8} lg={5}>
                    <Card className="shadow-lg border-0 rounded-4 overflow-hidden">
                        <div className="bg-success text-white text-center py-4">
                            ...
                            <p className="mb-0 text-white-50">Join our library community</p>
                        </div>
                        <Card.Body className="p-5">
                            {error && <Alert variant="danger" className="rounded-3 border-0">{error}</Alert>}
                            <Form onSubmit={handleSubmit}>
                                <Form.Group className="mb-4" controlId="formBasicName">
                                    <Form.Label className="text-muted fw-semibold small text-uppercase">Full Name</Form.Label>
                                    <div className="input-group">
                                        <span className="input-group-text bg-light border-end-0"><FaUser className="text-secondary"/></span>
                                        <Form.Control 
                                            type="text" 
                                ...
                                <Button variant="success" type="submit" className="w-100 rounded-pill py-2 fw-bold fs-5 mt-2 transition shadow-sm">
                                    Sign Up
                                </Button>
                            </Form>
